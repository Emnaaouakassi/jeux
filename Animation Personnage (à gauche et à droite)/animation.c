...
void anim()
{
	...
	perso.screen =NULL;
	perso.bg = IMG_Load("blanc.png");
	perso.imin1=IMG_Load("1.png");
	perso.imin2=IMG_Load("2.png");
	perso.imin3=IMG_Load("3.png");
	perso.imin4=IMG_Load("4.png");

	perso.issar1 = IMG_Load("5.png");
	perso.issar2 = IMG_Load("6.png");
	perso.issar3 = IMG_Load("7.png");
	perso.issar4 = IMG_Load("8.png");
